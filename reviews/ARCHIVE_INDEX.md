...
| MAPGEN-025 | land_fragment_1756_20260815/chatgpt_review | LAND_FRAGMENT target type added additively (scenario schema 1.4.0 → 1.5.0): 3,014 fragments recover 5,644 km² of coastal land, canonical 50,565 → 53,579 with TERRESTRIAL_HEX and ISLAND_COMPONENT gated unchanged. Physical geography untouched; `land_in_hexes()` becomes the only overlap-safe path from land tiles to a political area | MAPGEN-026 | reviews/MAPGEN-025/ |
| MAPGEN-026 | iberian_mainland_1756_20260816/chatgpt_review | first MAINLAND production. The specified 1755 IGN/CNIG raster was unavailable upstream (503/403/NoSuchKey); a bounded search adopted Le Rouge's 1756 *Atlas nouveau portatif* plate (Polona/Commons, Public Domain Mark 1.0, not Rumsey, not Gallica). The plate washes every PROVINCE, so the frontier falls out of a cell complex rather than a traced line. 34 observed correspondences, frozen split, POLYNOMIAL_2, measured p95 error 34.6 km — so only SAFE INTERIORS are claimed: Spain 5,431 hexes, Portugal 26, and 16,593 explicit UNRESOLVED rows. Canonical 53,579 → 75,629. Gibraltar, Andorra, Llívia, Olivenza, the Couto Misto, Ceuta and the Algarve withheld by name. **Re-filed by MAPGEN-027 as ACCEPTABLE_PRODUCTION_WITH_FOLLOWUP_GAPS**: Iberian LAND_FRAGMENT production was zero, the Algarve was withheld on a map title, and both crowns' individual evidence post-dated the snapshot | MAPGEN-027 | reviews/MAPGEN-026/ |
| MAPGEN-027 | portugal_recovery_1756_20260816/chatgpt_review | **latest completed stage** — Portugal 26 → 124 rows with Spain's hexes frozen at 5,431, and not one new measurement: the uncertainty is still 34.61 km. The Algarve is Portuguese on institutions (one chancery, one livro das Leys, two ordinary comarcas under the Ordenações, the décima), the unowned strips between Portugal's own traced cells are bridged where no cell of another crown lies in the corridor, and all 345 Iberian hexes that carry mainland land but are not terrestrial hexes now address it as LAND_FRAGMENTs — 139 of them sharing a hex with up to 103 other components. Both crowns gain authority dated BEFORE the snapshot. Canonical 75,629 → 76,576. A larger-scale 1762 Sanson/Vaugondy Portugal sheet (CC BY 4.0, Coimbra) is acquired and audited but deliberately not georeferenced: it draws towns as vignettes, which have no defensible anchor | — | reviews/MAPGEN-027/ |
